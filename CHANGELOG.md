...
【2026-09-13】【feat】components/schemas 中文名自动转拼音（每个音节首字母大写驼峰），«» 替换为下划线，生成合法 TypeScript 标识符
...
【2026-09-17】【feat】js 输出的 typedef 改为 @typedef {Object} + @property 形式，字段带上描述/示例，与 ts 输出一致
